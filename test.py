...
class UnitTests(unittest.TestCase):
    ...
    def test_deposit(self):
        ...
        self.assertEqual(actual, expected, 'Expected `deposit` method to create a specific object in the ledger '
                                           'instance variable.')
    ...
    def test_deposit_no_description(self):
        ...
        self.assertEqual(actual, expected, 'Expected calling `deposit` method with no description to create a blank '
                                           'description.')
    ...
    def test_withdraw(self):
        ...
        self.assertEqual(actual, expected, 'Expected `withdraw` method to create a specific object in the ledger '
                                           'instance variable.')
    ...
    def test_withdraw_no_description(self):
        ...
        self.assertEqual(actual, expected, 'Expected `withdraw` method with no description to create a blank '
                                           'description.')
    ...
    def test_transfer(self):
        ...
        self.assertEqual(actual, expected, 'Expected `transfer` method to create a specific ledger item in '
